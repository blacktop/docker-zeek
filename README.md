...
REPOSITORY           TAG          SIZE
blacktop/zeek        latest       40.6MB
blacktop/zeek        3.0          40.6MB
...
$ docker run --rm \
         -v `pwd`:/pcap \
         -v `pwd`/local.bro:/usr/local/zeek/share/zeek/site/local.zeek \  # All default modules loaded
